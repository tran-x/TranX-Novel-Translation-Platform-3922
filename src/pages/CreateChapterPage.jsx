    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">You need translator privileges to create chapters.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-black mb-2">Create New Chapter</h1>
          <p className="text-gray-600">Add a new chapter to {novel.title}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <RichTextEditor
              ...
              placeholder="Start writing the chapter content..."
            />
          </div>
