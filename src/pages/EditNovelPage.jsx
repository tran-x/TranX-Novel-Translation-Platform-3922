...
const EditNovelPage = () => {
  ...
  useEffect(() => {
    // Simulate loading novel data
    const mockNovel = {
      title: "Coiling Dragon",
      originalTitle: "盘龙",
      description: `<p>Empires rise and fall on the Yulan Continent. Saints, immortal beings of unimaginable power, battle using spells and swords...</p>`,
      originalAuthor: "I Eat Tomatoes",
      rawSource: "https://qidian.com/novel",
      type: "Chinese",
    ...
    setFormData(mockNovel);
    setVolumes([
      { id: 1, name: "Volume 1: The Ring Awakens", startChapter: "1" },
      { id: 2, name: "Volume 2: Coiling Dragon Ring", startChapter: "21" }
    ]);
  }, [novelSlug]);
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">You need translator privileges to edit novels.</p>
        </div>
      </div>
    );
  }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('Updating novel:', processedData);
  ...
  return (
    <div className="min-h-screen bg-white py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-black mb-2">Edit Novel</h1>
          <p className="text-gray-600">Update novel information</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          {/* Volumes */}
          <div className="bg-white border border-gray-200 rounded-lg p-6">
            <h2 className="text-xl font-bold text-black mb-6">Volumes</h2>
          ...
          <div className="flex justify-end space-x-4">
            <button
              type="button"
              onClick={() => navigate(`/novel/${novelSlug}`)}
